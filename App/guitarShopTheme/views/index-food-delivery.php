...
<head>
    ...
    <link href="food-delivery/css/line-awesome.min.css" rel="stylesheet">
    <link href="vendor/css/revolution-settings.min.css" rel="stylesheet">
    <link href="vendor/css/jquery.fancybox.min.css" rel="stylesheet">
    <link href="vendor/css/owl.carousel.min.css" rel="stylesheet">
    <link href="vendor/css/cubeportfolio.min.css" rel="stylesheet">
    <link href="vendor/css/LineIcons.min.css" rel="stylesheet">
    <link href="food-delivery/css/slick-theme.css" rel="stylesheet">
    <link href="food-delivery/css/slick.css" rel="stylesheet">
    <link href="vendor/css/wow.css" rel="stylesheet">
    <!-- Style Sheet -->
    <link href="food-delivery/css/select2.min.css" rel="stylesheet">
    <link href="food-delivery/css/style.css" rel="stylesheet">
</head>
                ...
                <div class="row">
                    <div class="col-6 col-lg-3">
                        <a class="navbar-brand link" href="index-food-delivery.html">
                            <img src="food-delivery/img/logo.png" class="" alt="logo">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <div class="navbar-nav ml-auto mr-auto">
                                    <a class="nav-link scroll link" href="#gallery-sec">Browse Food</a>
                                    <a class="nav-link scroll link" href="#app-sec">Download App</a>
            ...
            <div class="container">
                <div class="row w-100 side-menu-inner-content">
                    <div class="col-12 d-flex justify-content-center align-items-center">
                        <a href="index-food-delivery.html" class="navbar-brand"><img src="food-delivery/img/logo-white-small.png" alt="logo"></a>
                    </div>
                    <div class="col-12 col-lg-8">
                        <nav class="side-nav w-100">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link scroll" href="#gallery-sec">Browse Food</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link scroll" href="#app-sec">Download App</a>
                                </li>
                                <li class="nav-item">
            ...
            <ul>	<!-- SLIDE  -->
                <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 5; white-space: nowrap; font-size: 28px; line-height: 70px; font-weight: 300;opacity: .8; color: #ffffff; letter-spacing: 0;font-family:'Roboto', sans-serif;">Lorem ipsum dolor sit amet purus.</div>
                    ...
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-1"
                         ...
                         style="z-index: 6;font-size: 75px; line-height: 85px; font-weight: 400; letter-spacing: 0;font-family: 'Grand Hotel', cursive;"><span class="color-white">Delicious food at your door step.</span> </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 7; min-width: 570px; max-width: 570px; white-space: normal; font-size: 18px; line-height: 26px; font-weight: 300; color: #ffffff;opacity: .8; letter-spacing: 0;font-family:'Roboto', sans-serif;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae egestas mi, vel dapibus diam. Mauris malesuada, nisl non rutrum commodo, sem magna.</div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 9;">
                        <div class="rs-looped rs-pendulum"  data-easing="" data-startdeg="-5" data-enddeg="5" data-speed="3" data-origin="80% 60%"><img src="food-delivery/img/slider-ele1.png" alt="" data-ww="['267px','184px','145px','145px']" data-hh="['270px','186px','146px','146px']" data-no-retina> </div></div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 10;"><img data-depth="0.03" src="food-delivery/img/slider-ele3.png" alt="" data-ww="['545px','327px','264px','174px']" data-hh="['498px','299px','251px','161px']" data-no-retina> </div>
                    ...
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-0"
                         ...
                         style="z-index: 14;">
                        <div class="rs-looped rs-pendulum"  data-easing="easeInOutQuart" data-startdeg="-5" data-enddeg="5" data-speed="5" data-origin="80% 50%"><img src="food-delivery/img/slider-ele5.png" alt="" data-ww="['90px','105px','105px','105px']" data-hh="['85px','103px','103px','103px']" data-no-retina> </div></div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 15;"><img data-depth="0.05" src="food-delivery/img/slider-ele4.png" alt="" data-ww="['199px','191px','200px','150px']" data-hh="['270px','301px','259px','200px']" data-no-retina> </div>
                </li>
            </ul>
                ...
                <form class="row contact-form rounded-pill link no-gutters" id="contact-form-data">
                    ...
                    <div class="col-12 col-lg-8 d-inline-block d-lg-flex align-items-center">
                        <div class="form-group">
                            ...
                            <input type="text" name="userName" placeholder="Your Address" class="form-control">
                        </div>
                    </div>
                    <div class="col-12 col-lg-4">
                        <a href="food-delivery/restaurant-listing.html" class="btn main-btn rounded-pill w-100 contact_btn"><i class="fa fa-spinner fa-spin mr-2 d-none" aria-hidden="true"></i>CHECK FOOD DELIVERY
                        </a>
                    </div>
                </form>
            </div>
                ...
                <div class="row no-gutters">
                    <div class="col-12 col-lg-6 text-center text-lg-left">
                        <div class="heading-area">
                            <span class="sub-heading">Basic info about online food.</span>
                ...
                <div class="row padding-top portfolio-area">
                        ...
                        <div class="portfolio-inner-content">
                            <a href="food-delivery/restaurant-detail.html">
                                <div class="item-img-holder position-relative">
                                    <img src="food-delivery/img/item1.png">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 portfolio-item">
                        <div class="portfolio-inner-content">
                            <a href="food-delivery/restaurant-detail.html">
                                <div class="item-img-holder position-relative">
                                    <img src="food-delivery/img/item2.png">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 portfolio-item">
                        <div class="portfolio-inner-content">
                            <a href="food-delivery/restaurant-detail.html">
                                <div class="item-img-holder position-relative">
                                    <img src="food-delivery/img/item3.png">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 portfolio-item">
                        <div class="portfolio-inner-content">
                            <a href="food-delivery/restaurant-detail.html">
                                <div class="item-img-holder position-relative">
                                    <img src="food-delivery/img/item4.png">
                                    <div class="item-badge rounded-circle">25<span>mins</span></div>
                                </div>
                                <div class="item-detail-area">
                                    <div class="d-flex justify-content-between">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 portfolio-item">
                        <div class="portfolio-inner-content">
                            <a href="food-delivery/restaurant-detail.html">
                                <div class="item-img-holder position-relative">
                                    <img src="food-delivery/img/item5.png">
                                    <div class="item-badge rounded-circle">50<span>mins</span></div>
                                </div>
                                <div class="item-detail-area">
                                    <div class="d-flex justify-content-between">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 portfolio-item">
                        <div class="portfolio-inner-content">
                            <a href="food-delivery/restaurant-detail.html">
                                <div class="item-img-holder position-relative">
                                    <img src="food-delivery/img/item6.png">
                                    <div class="item-badge rounded-circle">45<span>mins</span></div>
                                </div>
                                <div class="item-detail-area">
                                    <div class="d-flex justify-content-between">
            ...
            <div class="col-md-12">
                ...
                <div class="feedback-slides">
                    <div class="client-thumbnails">
                        <div>
                            <div class="item">
                                <div class="img-fill"><img src="food-delivery/img/client2.jpg" alt="client"></div>
                                <div class="title">
                            ...
                            <div class="item">
                                <div class="img-fill"><img src="food-delivery/img/client1.jpg" alt="client"></div>
                            ...
                            <div class="item">
                                <div class="img-fill"><img src="food-delivery/img/client3.jpg" alt="client"></div>
                            ...
                            <div class="item">
                                <div class="img-fill"><img src="food-delivery/img/client4.jpg" alt="client"></div>
                ...
                <div class="row apps-details">
                        ...
                        <a href="https://www.apple.com/ios/app-store/">
                            <div class="app-l">
                                <div class="img-holder">
                                    <img src="food-delivery/img/app1.png">
                                </div>
                    ...
                    <div class="col-12 col-md-6">
                        <a href="https://play.google.com/store/apps?hl=en">
                            <div class="app-l">
                                <div class="img-holder">
                                    <img src="food-delivery/img/app2.png">
                                </div>
...
<script src="food-delivery/js/select2.min.js"></script>
<script src="food-delivery/js/notify.min.js"></script>
<script src="vendor/js/contact_us.js"></script>
<script src="food-delivery/js/script.js"></script>
